...
const maquinaPost = async (req, res) => {
    const { nombre, serial, imagen, af, estado } = req.body
    const maquina = new Maquinas({ nombre, serial, imagen, af, estado })
    await maquina.save()
    res.json({
...
const maquinaPut = async (req, res) => {
    const { id } = req.params
    const { nombre, serial, imagen, af, estado } = req.body
    const maquina = await Maquinas.findByIdAndUpdate(id, { nombre, serial, imagen, af, estado })
    res.json({
